						...
						janus.attach(
							{
								...
								success: function(pluginHandle) {
									...
									//ROBA MIA (bottone per selezionare la stanza a cui collegarsi)
								...
								onmessage: function(msg, jsep) {
									...
									if(event != undefined && event != null) {
										...
										if(event === "joined") {
											...
											// codice aggiunto da me per controllare la lista di room disponibili a cui connettermi
...
function registerUsername() {
	...
	// QUESTA ROBA NON MI SERVER PERCHÈ QUESTA FUNZIONE VIENE CHIAMATA PER COLLEGARSI ALLA STANZA DI DEFAULT CON IL NOME DEFAULT 
